...
public class cc100GameDataManager : MonoBehaviour
{
    // このクラスの唯一のインスタンスを保持する（シングルトン）
    public static cc100GameDataManager Instance;
    ...
    public void SelectCharacter(int layer)
    {
        ...
        // "100cc course selection scene" へ遷移
        SceneManager.LoadScene("100cc course selection scene");
    }
