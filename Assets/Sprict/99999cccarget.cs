...
public class cc99999CharacterSpawner : MonoBehaviour
{
    // スポーンさせたい位置
    [SerializeField]
    ...
    void Start()
    {
        ...
        if (cc99999GameDataManager.Instance == null)
        {
        ...
        int selectedLayer = cc99999GameDataManager.Instance.SelectedCharacterLayer;
